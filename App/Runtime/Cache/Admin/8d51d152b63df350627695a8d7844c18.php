...
<body>
<form action="<?php echo U(GROUP_NAME.'/Category/addhandle');?>" method="post">
	<table class='table  table-hover' style="width:900px;" align="center">
		<thead>
		<tr>
			<th colspan="5"><h2><p class="text-warning">友情链接网站</p></h1></th>
		</tr>
			<tr>
				<th width="10%">ID</th>
				<th width="40%">网站名称</th>
		...
		<tbody>
			<?php if(is_array($links)): foreach($links as $key=>$v): ?><tr>
				...
				<td>
				<a href="<?php echo U(GROUP_NAME.'/Linksmanage/linksedit',array('id'=>$v['id']));?>">[修改]</a>
				<a href="<?php echo U(GROUP_NAME.'/Linksmanage/linksdelete',array('id'=>$v['id']));?>">[删除]</a>
				</td>
